...
# bulid x264-stable
# {
sh ${ffmpeg_root_path}/3rdpartys/x264-stable/build_scripts/build_qnx710.sh
X264_PATH=${ffmpeg_root_path}/3rdpartys/x264-stable/install/${ARCH}-qnx710-x264-stable
